...
func (_q *UserQuery) QuerySettings() *UserSettingsQuery {
	query := (&UserSettingsClient{config: _q.config}).Query()
...
func (_q *UserQuery) WithSettings(opts ...func(*UserSettingsQuery)) *UserQuery {
	query := (&UserSettingsClient{config: _q.config}).Query()
...
func (_q *UserQuery) loadSettings(ctx context.Context, query *UserSettingsQuery, nodes []*User, init func(*User), assign func(*User, *UserSettings)) error {
